...
Handler h1047258049 = new Handler();
h1047258049.from(state_TimerJava_SoftTimer_default);
h1047258049.event(timer_startType);
h1047258049.guard((Event e)->{
...
h1047258049.port(timer_port);
h1047258049.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
