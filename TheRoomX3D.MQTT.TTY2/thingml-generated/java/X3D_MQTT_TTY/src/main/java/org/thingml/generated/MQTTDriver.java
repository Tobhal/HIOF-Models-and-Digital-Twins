...
Transition h453600463 = new Transition();
h453600463.from(state_MQTTDriver_behaviorMQTTDriver_Alive1).to(state_MQTTDriver_behaviorMQTTDriver_Alive2);
h453600463.event(iamalive1Type);
h453600463.port(require_val_port);
h453600463.action((Event e)->{
sendIamalive2_via_provide_temp();
});

Transition h1481668656 = new Transition();
h1481668656.from(state_MQTTDriver_behaviorMQTTDriver_Alive1).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1481668656.event(iamalive2Type);
h1481668656.port(require_val_port);
h1481668656.action((Event e)->{
sendIamalive2_via_provide_temp();
});

Transition h1215434191 = new Transition();
h1215434191.from(state_MQTTDriver_behaviorMQTTDriver_Alive2).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1215434191.event(iamalive2Type);
h1215434191.port(require_val_port);
Transition h1988152146 = new Transition();
h1988152146.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1988152146.event(temperatureType);
h1988152146.port(MQTT_port);
h1988152146.action((Event e)->{
...
Transition h1527444753 = new Transition();
h1527444753.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1527444753.event(add_thermometerType);
h1527444753.port(require_val_port);
h1527444753.action((Event e)->{
...
Transition h1919510349 = new Transition();
h1919510349.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1919510349.event(add_deviceType);
h1919510349.port(require_val_port);
h1919510349.action((Event e)->{
...
Transition h1528968613 = new Transition();
h1528968613.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1528968613.event(SwitchOnType);
h1528968613.port(require_val_port);
h1528968613.action((Event e)->{
...
Transition h785703145 = new Transition();
h785703145.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h785703145.event(SwitchOffType);
h785703145.port(require_val_port);
h785703145.action((Event e)->{
