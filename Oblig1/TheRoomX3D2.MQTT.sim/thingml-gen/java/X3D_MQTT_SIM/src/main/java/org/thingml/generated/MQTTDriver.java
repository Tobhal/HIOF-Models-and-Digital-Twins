...
Transition h177127253 = new Transition();
h177127253.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h177127253.event(temperatureType);
h177127253.port(MQTT_port);
h177127253.action((Event e)->{
...
Transition h1512757677 = new Transition();
h1512757677.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1512757677.event(luminanceType);
h1512757677.port(MQTT_port);
h1512757677.action((Event e)->{
...
Transition h410454840 = new Transition();
h410454840.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h410454840.event(add_thermometerType);
h410454840.port(require_val_port);
h410454840.action((Event e)->{
...
Transition h2129063697 = new Transition();
h2129063697.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h2129063697.event(add_deviceType);
h2129063697.port(require_val_port);
h2129063697.action((Event e)->{
...
Transition h1571073173 = new Transition();
h1571073173.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1571073173.event(SwitchOnType);
h1571073173.port(require_val_port);
h1571073173.action((Event e)->{
...
Transition h1546536451 = new Transition();
h1546536451.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h1546536451.event(SwitchOffType);
h1546536451.port(require_val_port);
h1546536451.action((Event e)->{
...
Transition h90354183 = new Transition();
h90354183.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h90354183.event(add_lightsensorType);
h90354183.port(require_val_port);
h90354183.action((Event e)->{
...
Transition h849152900 = new Transition();
h849152900.from(state_MQTTDriver_behaviorMQTTDriver_Idle).to(state_MQTTDriver_behaviorMQTTDriver_Idle);
h849152900.event(luminanceType);
h849152900.port(MQTT_port);
h849152900.action((Event e)->{
final LuminanceMessageType.LuminanceMessage luminance = (LuminanceMessageType.LuminanceMessage) e;
MQTTDriver_id_s_var = (int) (luminance.id);
MQTTDriver_i_var = (int) (0);
