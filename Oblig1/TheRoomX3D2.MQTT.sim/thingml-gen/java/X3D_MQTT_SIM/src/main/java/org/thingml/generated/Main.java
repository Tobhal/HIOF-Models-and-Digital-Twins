...
public static Simulation Simulation_sim;
...
public static Energy_saver Energy_saver_ES;
public static void main(String args[]) {
//Things
Human_myself = (Human) new Human();
Human_myself.buildBehavior(null, null);
Human_myself.init();
Simulation_sim = (Simulation) new Simulation();
Simulation_sim.buildBehavior(null, null);
Simulation_sim.init();
...
PIM_pim.init();
Energy_saver_ES = (Energy_saver) new Energy_saver();
Energy_saver_ES.buildBehavior(null, null);
Energy_saver_ES.init();
...
Simulation_sim.getSend_luminence_port().addListener(Energy_saver_ES.getGet_luminance_port());
Human_myself.getSend_cmd_port().addListener(Energy_saver_ES.getHuman_input_port());
...
Energy_saver_ES.getTempAdjust_port().addListener(PIM_pim.getHuman_input_port());
...
Energy_saver_ES.getSet_lum_port().addListener(Simulation_sim.getGet_lum_threshold_port());
...
Energy_saver_ES.initEnergy_saver_temp_var((double) (20));
Energy_saver_ES.initEnergy_saver_tempDecrease_var((double) (2));
Energy_saver_ES.initEnergy_saver_nightDecrease_var((double) (8));
Energy_saver_ES.initEnergy_saver_lum_threshold_var((double) (200));
Energy_saver_ES.initEnergy_saver_luminance_val_var((double) (100));
Energy_saver_ES.initEnergy_saver_lum_id_var((int)0);
