...
public static TimerClientMock TimerClientMock_t;
...
TimerClientMock_t = (TimerClientMock) new TimerClientMock();
TimerClientMock_t.buildBehavior(null, null);
TimerClientMock_t.init();
TimerJava_g_humn = (TimerJava) new TimerJava();
TimerJava_g_humn.buildBehavior(null, null);
TimerJava_g_humn.init();
//Connecting internal ports...
//Connectors
PIM_pim.getHuman_output_port().addListener(Energy_saver_es.getGet_cmd_port());
...
Energy_saver_es.getProvide_cmd_port().addListener(PIM_pim.getHuman_input_port());
MQTTDriver_T1.getProvide_lum_motion_port().addListener(Energy_saver_es.getGet_cmd_port());
...
Energy_saver_es.initEnergy_saver_last_lum_var((double) (1000));
Energy_saver_es.initEnergy_saver_lights_off_temp_var((double) (2));
Energy_saver_es.initEnergy_saver_night_var((double) (8));
Energy_saver_es.initEnergy_saver_lum_threshold_var((double) (1000));
Energy_saver_es.initEnergy_saver_lumSens_id_var((int)0);
